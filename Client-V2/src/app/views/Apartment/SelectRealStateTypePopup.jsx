...
import {getByRoot} from '../RealStateType/RealStateTypeService'
...
class SelectRealStateTypePopup extends React.Component {
  constructor(props) {
    super(props);
    ...
    return (
      <Dialog onClose={handleClose} open={open} PaperComponent={PaperComponent} maxWidth={'md'} fullWidth>
        <DialogTitle style={{ cursor: 'move' }} id="draggable-dialog-title">
          <span className="mb-20">{t("title.stateType")}</span>
        </DialogTitle>
        <DialogContent>
          {/* <Grid item xs={12}>
            <Input
...
export default SelectRealStateTypePopup;