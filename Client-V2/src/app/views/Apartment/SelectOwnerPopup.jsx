...
import {searchByRealEstateOwner} from './ApartmentService'
...
class SelectOwnerPopup extends React.Component {
  constructor(props) {
    super(props);
  ...
  updatePageData = () => {
    ...
    searchByRealEstateOwner(searchObject).then(({ data }) => {
    ...
    return (
      <Dialog onClose={handleClose} open={open} PaperComponent={PaperComponent} maxWidth={'md'} fullWidth>
        <DialogTitle style={{ cursor: 'move' }} id="draggable-dialog-title">
          <span className="mb-20">{t("apartment.owner")}</span>
        </DialogTitle>
        <DialogContent>
          <Grid item xs={12}>
            <Input
