...
class Building extends React.Component {
  ...
  handleConfirmationResponse = () => {
    ...
    deleteItem(this.state.id).then(() => {
      ...
      toast.warning(t("building.warning-delete"));
    });
  };
  handleEditItem = (item) => {
    this.setState({
  ...
  async handleDeleteList(list) {
    ...
    if (listAlert.length === list.length) {
      toast.warning(t("building.use_all"));
      // alert("Các trạng thái đều đã sử dụng");
    } else if (listAlert.length > 0) {
      toast.warning(t("building.deleted_unused"));
  ...
  render() {
    ...
    let TitlePage = t("title.building");
    ...
    let columns = [
      ...
      { title: t("general.name") + " " + t("title.building"), field: "name", width: "150" },
      { title: t("general.code"), field: "code", align: "left", width: "150" },
      { title: t("building.numberOfFloors"), field: "numberOfFloors", width: "150" },
