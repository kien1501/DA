import {
  ...
  import {
    ...
    getAllItem,
    deleteCheckItem,
  } from "./RequirementTypeService";
  
  
  import RequirementTypeDialog from "./RequirementTypeDialog";
  ...
  class RequirementType extends React.Component {
    state = {
      rowsPerPage: 5,
      page: 0,
      data: [],
    ...
    render() {
      ...
      let TitlePage = t("directory.RequirementType");
