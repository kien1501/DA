...
class Project extends React.Component {
  ...
  handleConfirmationResponse = () => {
    ...
    .catch(() => {
      toast.warning(t("project.warning-delete"));
    });
  };
  handleEditItem = (item) => {
    this.setState({
  ...
  async handleDeleteList(list) {
    ...
    if (listAlert.length === list.length) {
      toast.warning(t("project.use_all"));
      // alert("Các trạng thái đều đã sử dụng");
    } else if (listAlert.length > 0) {
      toast.warning(t("project.deleted_unused"));
  ...
  render() {
    ...
    let columns = [
      ...
      { title: t("title.urbanArea"), field: "urbanArea.name", width: "150" },
      { title: t("general.name") + " " + t("title.project") , field: "name", width: "150" },
    ...
    return (
      <div className="m-sm-30">
        ...
        <div className="mb-sm-30">
          ...
          <Breadcrumb
            routeSegments={[
              { name: t("Dashboard.category"), path: "/directory/project" },
              { name: TitlePage },
            ]}
          />
        </div>
